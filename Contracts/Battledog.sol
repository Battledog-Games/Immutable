...
import {OperatorAllowlistEnforced}  from "https://github.com/immutable/contracts/blob/main/contracts/allowlist/OperatorAllowlistEnforced.sol";

interface Iburn {
    function Burn(uint256 _amount) external;
}

contract battledog is ERC721Enumerable, OperatorAllowlistEnforced, Ownable, ReentrancyGuard {        
